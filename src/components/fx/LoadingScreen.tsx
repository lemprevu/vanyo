 ...
 *
 * Important : l'overlay reste TOUJOURS monté et son opacité est pilotée
 * directement par l'état React (pas par AnimatePresence). `pointerEvents`
 * est mis à jour de façon synchrone avec l'état `visible`, indépendamment
 * de la fin de l'animation de fondu — si on se fiait uniquement à la fin
 * de l'animation pour retirer l'overlay du DOM, un ralentissement ou un
 * onglet en arrière-plan pourrait la bloquer indéfiniment et rendre tout
 * le site en dessous non cliquable, invisible mais toujours présent.
 */
